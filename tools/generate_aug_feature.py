...
def generate_aug_results(cfg, local_rank, distributed, logger, mix_up_path):
...
def main():
    ...
    generate_aug_results(cfg, args.local_rank, args.distributed, logger, cfg.MIXUP.FEAT_PATH)
