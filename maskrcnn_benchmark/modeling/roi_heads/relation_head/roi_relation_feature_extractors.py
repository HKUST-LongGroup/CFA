        ...
        if cfg.MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL == False and cfg.MODEL.ROI_RELATION_HEAD.USE_GT_BOX == True:
            ...
            if cfg.FG_TAIL == True:
                if cfg.MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL == True:
                    self.tail_features_dict = np.load(os.path.join(cfg.MIXUP.FEAT_PATH, 'predcls_tail_sub_obj_feature_with_proposal_dict_motif.npy'), allow_pickle=True)
                else:
            ...
            if cfg.FG_BODY == True:
                if cfg.MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL == True:
                    self.body_features_dict = np.load(os.path.join(cfg.MIXUP.FEAT_PATH, 'predcls_body_sub_obj_feature_with_proposal_dict_motif.npy'), allow_pickle=True)
                else:
            ...
            if cfg.MIXUP.MIXUP_ADD_TAIL == True:
                if cfg.MODEL.ROI_RELATION_HEAD.USE_GT_OBJECT_LABEL == True:
                    self.tail_obj_dict = np.load(os.path.join(cfg.MIXUP.FEAT_PATH, 'predcls_tail_obj_only_feature_with_proposal_dict_motif.npy'), allow_pickle=True).item()
                    self.tail_sub_dict = np.load(os.path.join(cfg.MIXUP.FEAT_PATH, 'predcls_tail_sub_only_feature_with_proposal_dict_motif.npy'), allow_pickle=True).item()
                else:
