...
class RelationLossComputation(object):
    ...
    def __call__(self, proposals, rel_labels, relation_logits, refine_logits, cur_iter=None, rel_pair_idxs=None, all_changed_classes=None, all_change_to_classes=None):
        """
        Computes the loss for relation triplet.
